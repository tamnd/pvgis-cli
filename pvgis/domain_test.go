...
// HTTP behaviour is covered in pvgis_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "pvgis://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("pvgis", "about")
	if err != nil || got.String() != "pvgis://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want pvgis://page/about", got.String(), err)
	}
}
