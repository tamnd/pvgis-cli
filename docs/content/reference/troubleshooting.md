...
Most of these come down to network reality or how pvgis serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pvgis rate-limits like any public site. pvgis already paces
...
Where a surface is gated, pvgis reads a cookie or token you supply
...
`pvgis`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pvgis actually did
